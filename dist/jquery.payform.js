...
(function($) {
  ...
  $.payform.fn = {
    ...
    formatCardExpiry: function(option) {
      return payform.expiryInput(this.get(0), option);
    },
  ...
  return $.fn.payform = function(method, option) {
    if ($.payform.fn[method] != null) {
      $.payform.fn[method].call(this, option);
    }
    return this;
  };
